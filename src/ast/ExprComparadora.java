...
//	exprComparadora:expresion -> left:expresion  operador:String  right:expresion

public class ExprComparadora extends AbstractExpresion {

	public ExprComparadora(Expresion left, String operador, Expresion right) {
		this.left = left;
	...
	public ExprComparadora(Object left, Object operador, Object right) {
