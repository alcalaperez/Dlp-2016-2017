...
//	while:cuerpoMetodo -> condicion:expresion  cuerpo:cuerpoMetodo*

public class While extends AbstractCuerpoMetodo {

	public While(Expresion condicion, List<CuerpoMetodo> cuerpo) {
	...
	public While(Object condicion, Object cuerpo) {
