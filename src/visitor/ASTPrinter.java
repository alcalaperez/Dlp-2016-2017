...
public class ASTPrinter extends DefaultVisitor {
	...
	public Object visit(DefVariableLocal node, Object param) {
		...
		print(indent + 1, "direccion", "int", "BP" + node.getDireccion());
	...
	public Object visit(DefMetodo node, Object param) {
		...
		printName(indent, "DefMetodo", node, false);

		print(indent + 1, "nombre", "String", node.getNombre());
		visit(indent + 1, "parametro", "List<Parametro>",node.getParametro());
		visit(indent + 1, "tipo", "Tipo",node.getTipo());
		visit(indent + 1, "cuerpo", "List<CuerpoMetodo>",node.getCuerpo());
		return null;
	}
	...
	public Object visit(IdentType node, Object param) {
		...
		printCompact(indent, "IdentType", node, "objeto", node.getObjeto());
		return null;
	}
	...
	public Object visit(ArrayType node, Object param) {
		...
		print(indent + 1, "indice", "int", node.getIndice());
		visit(indent + 1, "tipo", "Tipo",node.getTipo());
		return null;
	}
	...
	public Object visit(IfElse node, Object param) {
		...
		visit(indent + 1, "condicion", "Expresion",node.getCondicion());
		visit(indent + 1, "cuerpoIf", "List<CuerpoMetodo>",node.getCuerpoIf());
		visit(indent + 1, "cuerpoElse", "List<CuerpoMetodo>",node.getCuerpoElse());
		return null;
	}
	...
	public Object visit(Print node, Object param) {
		...
		visit(indent + 1, "expresionImprimir", "Expresion",node.getExpresionImprimir());
		return null;
	}
	...
	public Object visit(Read node, Object param) {
		...
		visit(indent + 1, "expresionLeer", "Expresion",node.getExpresionLeer());
		return null;
	}
	...
	public Object visit(InvocarMetodo node, Object param) {
		...
		printName(indent, "InvocarMetodo", node, false);

		print(indent + 1, "nombreMetodo", "String", node.getNombreMetodo());
	...
	public Object visit(ExprComparadora node, Object param) {
		...
		printName(indent, "ExprComparadora", node, false);
	...
	public Object visit(ExprComparadoraNot node, Object param) {
		...
		printName(indent, "ExprComparadoraNot", node, false);
	...
	public Object visit(ExprAccesoObjeto node, Object param) {
		...
		printName(indent, "ExprAccesoObjeto", node, false);

		visit(indent + 1, "left", "Expresion",node.getLeft());
		print(indent + 1, "variable", "String", node.getVariable());
		return null;
	}
	...
	public Object visit(ExprArray node, Object param) {
		...
		printName(indent, "ExprArray", node, false);
	...
	public Object visit(ExprInvocarMetodo node, Object param) {
		...
		printName(indent, "ExprInvocarMetodo", node, false);

		print(indent + 1, "metodo", "String", node.getMetodo());
		visit(indent + 1, "expresion", "List<Expresion>",node.getExpresion());
		return null;
	}
