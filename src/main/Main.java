...
public class Main {
	...
	//Identificacion
	//public static final String programa = "src/1. Funciones.txt";	// Entrada a usar durante el desarrollo
	//public static final String programa = "src/2. Estructuras.txt";	// Entrada a usar durante el desarrollo
	//public static final String programa = "src/3. Variables.txt";	// Entrada a usar durante el desarrollo
	...
	//Gestion de memoria
	//public static final String programa = "src/Test Gestion de Memoria.txt";	// Entrada a usar durante el desarrollo

	
	//Generacion de codigo
	//public static final String programa = "src/Test de Generación de Código básico.txt";	// Entrada a usar durante el desarrollo
	//public static final String programa = "src/Test Generación de Código 1.txt";	// Entrada a usar durante el desarrollo
	//public static final String programa = "src/Test Generación de Código 2.txt";	// Entrada a usar durante el desarrollo
	//public static final String programa = "src/Test Generacion de Código 3.txt";	// Entrada a usar durante el desarrollo
	public static final String programa = "src/Test Generación de Código 4.txt";	// Entrada a usar durante el desarrollo
